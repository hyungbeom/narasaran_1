                ...
                <div style={{color: 'white', padding: 5}}>
                    ...
                    <div>
                        <div style={{fontSize: 11, display: 'flex', alignItems: 'center', paddingTop: 5, gap: 3}}>
                            <img src="https://sikaf.co.kr/icon/Calendar.svg" alt="" width={15}/> 25년 7월 12일
                        </div>
                        <div style={{
                            fontSize: 11,
                            display: 'flex',
                            ...
                            <img src="https://sikaf.co.kr/icon/Delivery Time.svg" alt="" width={15}/> 12:00 -
                            17:00
                        </div>
                        <div style={{
                            fontSize: 11,
                            ...
                            <img src="https://sikaf.co.kr/icon/Address.svg" alt="" width={15}/> 광화문 광장 놀이마당 일대
                        </div>
                    </div>
                        ...
                        <div>
                            <div style={{
                                ...
                                <img src="https://sikaf.co.kr/icon/Email.svg" alt="" width={15}/> sikafofficial
                            </div>
                            <div style={{
                                fontSize: 11,
                                display: 'flex',
                                ...
                                <img src="https://sikaf.co.kr/icon/Instagram.svg" alt="" width={15}/> sikaf_official
                            </div>
