...
export default function Exhibition() {
    ...
    return (<>            <div style={{...style, height : isMobile ? 230 : (isDesktop ? 280 : 300)}}>
            ...
            <div style={{paddingTop : 100, textAlign : 'center', fontSize : 20, fontWeight : 600, lineHeight : 2.2}}>
                제1회 서울 국제 어린이·청소년 아트 페스티벌은 <br/>
                전 세계 미래세대를 대상으로 예술을 통한 창의성과 표현력을 확장시키는 글로벌 문화예술 플랫폼입니다. <br/>
                본 페스티벌은 예술 활동을 매개로 한 융합적 콘텐츠와 참여형 프로그램을 통해 어린이·청소년이 스스로의 가능성을 발견하고, <br/>다양한 문화적 감수성을 경험할 수 있도록 기획되었습니다. 나아가 국제 교류와 예술교육을 연계하여,<br/>
                미래를 이끌 글로벌 인재로의 성장을 지원하는 문화예술 생태계의 새로운 허브로 자리매김하고자 합니다.
